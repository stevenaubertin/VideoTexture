...
#ifndef ShaderPreset_h
#define ShaderPreset_h
...
public:
    ShaderPreset()
        : name_{""}, vertexShader_{""}, fragmentShader_{""}{
    }
    ShaderPreset(const char* name, const char* vertexShader, const char* fragmentShader)
        : name_{name}, vertexShader_{vertexShader}, fragmentShader_{fragmentShader}{
    }
    const char* getName()const noexcept{
        return name_;
    }
    const char* getVertexShader()const noexcept{
        return vertexShader_;
    }
    const char* getFragmentShader()const noexcept{
